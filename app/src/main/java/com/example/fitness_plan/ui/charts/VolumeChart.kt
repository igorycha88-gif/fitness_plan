...
fun VolumeChart(
    ...
    secondaryColor: androidx.compose.ui.graphics.Color = androidx.compose.ui.graphics.Color.Gray
) {
    if (chartData.isEmpty) {
        return
    }

    val maxVolume = chartData.dataPoints.maxOf { it.volume }.toFloat() * 1.1f
    ...
    Canvas(
        ...
        chartData.dataPoints.forEachIndexed { index, point ->
            ...
            val barHeight = (point.volume.toFloat() / maxVolume) * usableHeight
